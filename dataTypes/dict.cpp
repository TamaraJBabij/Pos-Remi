//
// File generated by rootcint at Wed Feb 03 15:44:16 2016
...
namespace ROOTDict {
   ...
   static void streamer_Group(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::Group*)
   {
      ::Group *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::Group >(0);
      static ::ROOT::TGenericClassInfo 
         instance("Group", ::Group::Class_Version(), "./Group.h", 46,
                  typeid(::Group), ::ROOT::DefineBehavior(ptr, ptr),
                  &::Group::Dictionary, isa_proxy, 0,
                  sizeof(::Group) );
      ...
      instance.SetStreamerFunc(&streamer_Group);
      return &instance;
   }
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::DataSet*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("DataSet", ::DataSet::Class_Version(), "./DataSet.h", 11,
...
atomic_TClass_ptr Group::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *Group::Class_Name()
{
   return "Group";
}

//______________________________________________________________________________
const char *Group::ImplFileName()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::Group*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int Group::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::Group*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void Group::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::Group*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *Group::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::Group*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::DataSet*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int DataSet::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::DataSet*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void DataSet::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::DataSet*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *DataSet::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::DataSet*)0x0)->GetClass();} }
   return fgIsA;
}
...
void DataSet::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      {
         vector<Group*> &R__stl =  data;
         R__stl.clear();
         TClass *R__tcl1 = TBuffer::GetClass(typeid(Group));
         if (R__tcl1==0) {
            Error("data streamer","Missing the TClass object for Group!");
            return;
         }
         int R__i, R__n;
         R__b >> R__n;
         ...
         for (R__i = 0; R__i < R__n; R__i++) {
            Group* R__t;
            R__t = (Group*)R__b.ReadObjectAny(R__tcl1);
...
//______________________________________________________________________________
void Group::Streamer(TBuffer &R__b)
{
   // Stream an object of class Group.
   ...
   if (R__b.IsReading()) {
      ...
      TObject::Streamer(R__b);
      R__b >> id;
      R__b.StreamObject(&(electron),typeid(Particle));
      R__b.StreamObject(&(positron),typeid(Particle));
      R__b.StreamObject(&(ion),typeid(Particle));
      {
         vector<Hit> &R__stl =  rawData;
         R__stl.clear();
         TClass *R__tcl1 = TBuffer::GetClass(typeid(Hit));
         if (R__tcl1==0) {
            Error("rawData streamer","Missing the TClass object for Hit!");
            return;
         }
         int R__i, R__n;
         R__b >> R__n;
      ...
      {
         vector<Set> &R__stl =  setData;
         R__stl.clear();
         TClass *R__tcl1 = TBuffer::GetClass(typeid(Set));
         if (R__tcl1==0) {
            Error("setData streamer","Missing the TClass object for Set!");
            return;
         }
         int R__i, R__n;
         R__b >> R__n;
      ...
      R__b.CheckByteCount(R__s, R__c, Group::IsA());
   } else {
      R__c = R__b.WriteVersion(Group::IsA(), kTRUE);
      TObject::Streamer(R__b);
      R__b << id;
      R__b.StreamObject(&(electron),typeid(Particle));
      R__b.StreamObject(&(positron),typeid(Particle));
      R__b.StreamObject(&(ion),typeid(Particle));
      {
         ...
         if (R__tcl1==0) {
            ...
            vector<Hit>::iterator R__k;
            for (R__k = R__stl.begin(); R__k != R__stl.end(); ++R__k) {
            R__b.StreamObject((Hit*)&(*R__k),R__tcl1);
            }
         }
      }
      {
         ...
         if (R__tcl1==0) {
            ...
            vector<Set>::iterator R__k;
            for (R__k = R__stl.begin(); R__k != R__stl.end(); ++R__k) {
            R__b.StreamObject((Set*)&(*R__k),R__tcl1);
            }
         }
      }
      R__b.SetByteCount(R__c, kTRUE);
...
//______________________________________________________________________________
void Group::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class Group.
      typedef ::Group msvc_bug_workaround;
      TClass *R__cl = msvc_bug_workaround::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "id", &id);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "electron", (void*)&electron);
      R__insp.InspectMember("Particle", (void*)&electron, "electron.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "positron", (void*)&positron);
      R__insp.InspectMember("Particle", (void*)&positron, "positron.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ion", (void*)&ion);
      R__insp.InspectMember("Particle", (void*)&ion, "ion.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "rawData", (void*)&rawData);
      R__insp.InspectMember("vector<Hit>", (void*)&rawData, "rawData.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "setData", (void*)&setData);
      R__insp.InspectMember("vector<Set>", (void*)&setData, "setData.", false);
      TObject::ShowMembers(R__insp);
}
...
namespace ROOTDict {
   ...
   static void *new_Group(void *p) {
      return  p ? new(p) ::Group : new ::Group;
   }
   static void *newArray_Group(Long_t nElements, void *p) {
      return p ? new(p) ::Group[nElements] : new ::Group[nElements];
   }
   // Wrapper around operator delete
   static void delete_Group(void *p) {
      delete ((::Group*)p);
   ...
   // Wrapper around a custom streamer member function.
   static void streamer_Group(TBuffer &buf, void *obj) {
      ((::Group*)obj)->::Group::Streamer(buf);
   }
} // end of namespace ROOTDict for class ::Group

namespace ROOTDict {
   void vectorlEGroupmUgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void vectorlEGroupmUgR_Dictionary();
   static void *new_vectorlEGroupmUgR(void *p = 0);
   static void *newArray_vectorlEGroupmUgR(Long_t size, void *p);
   static void delete_vectorlEGroupmUgR(void *p);
   static void deleteArray_vectorlEGroupmUgR(void *p);
   static void destruct_vectorlEGroupmUgR(void *p);

   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const vector<Group*>*)
   {
      vector<Group*> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<Group*>),0);
      static ::ROOT::TGenericClassInfo 
         instance("vector<Group*>", -2, "prec_stl/vector", 49,
                  typeid(vector<Group*>), ::ROOT::DefineBehavior(ptr, ptr),
                  0, &vectorlEGroupmUgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<Group*>) );
      instance.SetNew(&new_vectorlEGroupmUgR);
      instance.SetNewArray(&newArray_vectorlEGroupmUgR);
      instance.SetDelete(&delete_vectorlEGroupmUgR);
      instance.SetDeleteArray(&deleteArray_vectorlEGroupmUgR);
      instance.SetDestructor(&destruct_vectorlEGroupmUgR);
      instance.AdoptCollectionProxyInfo( ::ROOT::TCollectionProxyInfo::Generate( ::ROOT::TCollectionProxyInfo::Pushback< vector<Group*> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<Group*>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void vectorlEGroupmUgR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const vector<Group*>*)0x0)->GetClass();
   }
...
namespace ROOTDict {
   // Wrappers around operator new
   static void *new_vectorlEGroupmUgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<Group*> : new vector<Group*>;
   }
   static void *newArray_vectorlEGroupmUgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<Group*>[nElements] : new vector<Group*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEGroupmUgR(void *p) {
      delete ((vector<Group*>*)p);
   }
   static void deleteArray_vectorlEGroupmUgR(void *p) {
      delete [] ((vector<Group*>*)p);
   }
   static void destruct_vectorlEGroupmUgR(void *p) {
      typedef vector<Group*> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOTDict for class vector<Group*>
...
namespace ROOTDict {
   void vectorlESetgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void vectorlESetgR_Dictionary();
   static void *new_vectorlESetgR(void *p = 0);
   static void *newArray_vectorlESetgR(Long_t size, void *p);
   static void delete_vectorlESetgR(void *p);
   static void deleteArray_vectorlESetgR(void *p);
   static void destruct_vectorlESetgR(void *p);

   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const vector<Set>*)
   {
      vector<Set> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<Set>),0);
      static ::ROOT::TGenericClassInfo 
         instance("vector<Set>", -2, "prec_stl/vector", 49,
                  typeid(vector<Set>), ::ROOT::DefineBehavior(ptr, ptr),
                  0, &vectorlESetgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<Set>) );
      instance.SetNew(&new_vectorlESetgR);
      instance.SetNewArray(&newArray_vectorlESetgR);
      instance.SetDelete(&delete_vectorlESetgR);
      instance.SetDeleteArray(&deleteArray_vectorlESetgR);
      instance.SetDestructor(&destruct_vectorlESetgR);
      instance.AdoptCollectionProxyInfo( ::ROOT::TCollectionProxyInfo::Generate( ::ROOT::TCollectionProxyInfo::Pushback< vector<Set> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<Set>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void vectorlESetgR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const vector<Set>*)0x0)->GetClass();
   }
...
namespace ROOTDict {
   // Wrappers around operator new
   static void *new_vectorlESetgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<Set> : new vector<Set>;
   }
   static void *newArray_vectorlESetgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<Set>[nElements] : new vector<Set>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlESetgR(void *p) {
      delete ((vector<Set>*)p);
   ...
   static void destruct_vectorlESetgR(void *p) {
      typedef vector<Set> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOTDict for class vector<Set>
...
{
      {
         ...
         vector<Hit,allocator<Hit> >::iterator xobj = ((Group*) G__getstructoffset())->begin();
...
static int G__dict_264_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<Hit,allocator<Hit> >::iterator* pobj;
         vector<Hit,allocator<Hit> >::iterator xobj = ((Group*) G__getstructoffset())->end();
         pobj = new vector<Hit,allocator<Hit> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
{
      ((Group*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      {
         vector<Group*,allocator<Group*> >::iterator* pobj;
         vector<Group*,allocator<Group*> >::iterator xobj = ((DataSet*) G__getstructoffset())->begin();
         pobj = new vector<Group*,allocator<Group*> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
      }
...
static int G__dict_274_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<Group*,allocator<Group*> >::iterator* pobj;
         vector<Group*,allocator<Group*> >::iterator xobj = ((DataSet*) G__getstructoffset())->end();
         pobj = new vector<Group*,allocator<Group*> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_274_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) DataSet::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_274_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) DataSet::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_274_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_inheritancedict() {
   ...
   /* Setting up class inheritance */
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__dictLN_Group))) {
     Group *G__Lderived;
     G__Lderived=(Group*)0x1000;
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dictLN_Group),G__get_linked_tagnum(&G__dictLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
...
static void G__setup_memfuncGroup(void) {
   ...
   G__memfunc_setup("begin",517,G__dict_264_0_5, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHitcOallocatorlEHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_264_0_6, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHitcOallocatorlEHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_264_0_7, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Group::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_264_0_8, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Group::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_264_0_9, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Group::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_264_0_10, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Group::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_264_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_264_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Group::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_264_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Group::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_264_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Group::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_264_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Group::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("Group", 525, G__dict_264_0_19, (int) ('i'), G__get_linked_tagnum(&G__dictLN_Group), -1, 0, 1, 1, 1, 0, "u 'Group' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Group", 651, G__dict_264_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_264_0_21, (int) ('u'), G__get_linked_tagnum(&G__dictLN_Group), -1, 1, 1, 1, 1, 0, "u 'Group' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
static void G__setup_memfuncDataSet(void) {
   ...
   G__memfunc_setup("begin",517,G__dict_274_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_274_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_274_0_5, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&DataSet::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_274_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DataSet::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_274_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&DataSet::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_274_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&DataSet::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_274_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_274_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DataSet::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_274_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&DataSet::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_274_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DataSet::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_274_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&DataSet::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("DataSet", 678, G__dict_274_0_17, (int) ('i'), G__get_linked_tagnum(&G__dictLN_DataSet), -1, 0, 1, 1, 1, 0, "u 'DataSet' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~DataSet", 804, G__dict_274_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_274_0_19, (int) ('u'), G__get_linked_tagnum(&G__dictLN_DataSet), -1, 1, 1, 1, 1, 0, "u 'DataSet' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__dictLN_vectorlEHitcOallocatorlEHitgRsPgRcLcLiterator = { "vector<Hit,allocator<Hit> >::iterator" , 99 , -1 };
...
G__linked_taginfo G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgRcLcLiterator = { "vector<Group*,allocator<Group*> >::iterator" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtabledict() {
  ...
  G__dictLN_vectorlEHitcOallocatorlEHitgRsPgRcLcLiterator.tagnum = -1 ;
  ...
  G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgRcLcLiterator.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtabledict() {
   ...
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlEHitcOallocatorlEHitgRsPgRcLcLiterator);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_Group),sizeof(Group),-1,62720,(char*)NULL,G__setup_memvarGroup,G__setup_memfuncGroup);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_DataSet),sizeof(DataSet),-1,29952,(char*)NULL,G__setup_memvarDataSet,G__setup_memfuncDataSet);
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgR);
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlEGroupmUcOallocatorlEGroupmUgRsPgRcLcLiterator);
