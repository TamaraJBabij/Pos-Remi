...
HistogramTimeSums calculateTimeSums(DataSet* data) {
	...
	timesums.layer_upos = new TH1D("upos", "TimeSum upos layer", 200, 50, 200);
	timesums.layer_vpos = new TH1D("vpos", "TimeSum vpos layer", 200, 50, 200);
	timesums.layer_wpos = new TH1D("wpos", "TimeSum wpos layer", 200, 50, 200);
	timesums.layer_uneg = new TH1D("uneg", "TimeSum uneg layer", 200, 50, 250);
	timesums.layer_vneg = new TH1D("vneg", "TimeSum vneg layer", 200, 50, 150);
